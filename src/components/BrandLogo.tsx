...
export function BrandLogo({className = ""}: BrandLogoProps) {
  return (
    <div className={`brand ${className}`.trim()} aria-label="chisel">
      <svg className="brand-mark" viewBox="8 4 30 30" aria-hidden="true">
        <path
          className="brand-mark-shadow"
          d="M11.6 30.9V14.5L20 6.1h3.3l7.2 7.2-7.4 7.4v3.1h6.3c.8 0 1.6.4 2.1 1l5 5.5c.6.7.1 1.8-.8 1.8H13.1c-.8 0-1.5-.5-1.5-1.2Z"
        />
